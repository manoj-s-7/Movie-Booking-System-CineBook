  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      ...
      <div className="relative z-10 px-8 py-5 flex items-center justify-between">
        ...
        <Link
          href="/register"
          className="text-sm text-white bg-white/10 hover:bg-white/20 px-4 py-2 rounded transition-colors border border-white/15"
        >
          Sign Up
        </Link>
      </div>
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center px-4 py-8">
        <div className="w-full max-w-sm">
          ...
          >
            ...
            <button className="w-full py-3 rounded border border-white/15 text-[#b3b3b3] hover:border-white/30 hover:text-white text-sm transition-colors">
              Use a sign‑in code
            </button>
