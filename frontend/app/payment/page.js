    ...
    <div className="flex gap-2 justify-center">
      {digits.map((d, i) => (
        <input
          ...
          className="w-11 h-13 bg-[#1a1a1a] border border-[rgba(139,92,246,0.20)] rounded-xl text-center text-white font-mono text-xl outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all"
          style={{ height: "52px" }}
        />
      ))}
    </div>
...
function UPISection({ onSuccess }) {
  ...
  return (
    <div className="space-y-4">
      {/* Tab switcher */}
      <div className="flex rounded-xl overflow-hidden border border-[rgba(139,92,246,0.16)]">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-2 mt-3 flex-wrap">
            {["PhonePe", "GPay", "Paytm", "BHIM", "Cred"].map(app => (
              <span key={app} className="px-2.5 py-1 rounded-lg bg-white/5 border border-[rgba(139,92,246,0.13)] text-xs text-[#666]">{app}</span>
            ))}
          </div>
        </div>
      ) : (
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-[#1a1a1a] border border-[rgba(139,92,246,0.20)] rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all"
              />
              <button
                onClick={verifyUpi}
          ...
          {steps.map((s, i) => (
            <div key={i} className="flex flex-col items-center gap-2">
              <div className={`w-9 h-9 rounded-full border-2 flex items-center justify-center transition-all duration-500 ${
                ...
                "border-[rgba(139,92,246,0.22)] bg-white/5"
              }`}>
...
function PaymentPageInner() {
  ...
  const validate = () => {
    ...
    if (method === "card") {
      ...
      if (!showOtp && !selectedBank) errs.bank = "Please select a bank";
      if (showOtp && otp.length < 6) errs.otp = "Enter the 6-digit OTP";
      if (showOtp && otp !== "123456") errs.otp = "Invalid OTP. Use demo OTP: 123456";
    } else if (method === "wallet") {
      if (!selectedWallet) errs.wallet = "Please select a wallet";
    }
    setErrors(errs);
    return errs; // return errors directly instead of reading stale state
  };
  ...
  const handlePay = () => {
    ...
    if (!isValid) {
      const firstErr = Object.values(errs)[0] || "Please fill all required fields";
        ...
        <div className="grid lg:grid-cols-3 gap-6">
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-1.5 py-4 px-2 rounded-xl border transition-all ${
                    method === id
                      ...
                      : "border-[rgba(139,92,246,0.13)] bg-[#111] text-[#666] hover:border-[rgba(139,92,246,0.28)] hover:text-[#b3b3b3]"
                  }`}
                >
                  <Icon size={22} />
            ...
            {method === "card" && (
              <div className="glass rounded-2xl p-6 glow-border fade-in">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#1a1a1a] border rounded-xl px-4 py-3.5 text-white font-mono text-sm outline-none transition-all ${
                        errors.number ? "border-red-500" : "border-[rgba(139,92,246,0.20)] focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20"
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#1a1a1a] border rounded-xl px-4 py-3.5 text-white uppercase tracking-wider text-sm outline-none transition-all ${
                        errors.name ? "border-red-500" : "border-[rgba(139,92,246,0.20)] focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20"
                      }`}
                    />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        maxLength={5}
                        className={`w-full bg-[#1a1a1a] border rounded-xl px-4 py-3.5 text-white font-mono text-sm outline-none transition-all ${
                          errors.expiry ? "border-red-500" : "border-[rgba(139,92,246,0.20)] focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20"
                        }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        maxLength={4}
                        className={`w-full bg-[#1a1a1a] border rounded-xl px-4 py-3.5 text-white font-mono text-sm outline-none transition-all ${
                          errors.cvv ? "border-red-500" : "border-[rgba(139,92,246,0.20)] focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20"
                        }`}
                      />
                  ...
                  <div className="flex items-center gap-2 p-3 rounded-xl bg-white/3 border border-[rgba(139,92,246,0.08)]">
              ...
              <div className="glass rounded-2xl p-6 glow-border fade-in">
                ...
                {!showOtp ? (
                        ...
                        <button
                          ...
                          className={`p-3 rounded-xl border text-center transition-all ${
                            selectedBank === bank.id
                              ...
                              : "border-[rgba(139,92,246,0.13)] bg-[#1a1a1a] hover:border-[rgba(139,92,246,0.28)]"
                          }`}
                        >
                          <div
                  ...
                  <div className="space-y-5">
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-[rgba(139,92,246,0.13)]">
                      <div
                      ...
                      <button onClick={() => setShowOtp(false)} className="ml-auto text-[#555] hover:text-white text-xs border border-[rgba(139,92,246,0.13)] px-2 py-1 rounded-lg transition-all">
                        Change
                      </button>
                    </div>
                  ...
                  {WALLETS.map(wallet => (
                    ...
                    >
                      ...
                      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                        selectedWallet === wallet.id ? "border-purple-500 bg-purple-500" : "border-[rgba(139,92,246,0.28)]"
                      }`}>
          ...
          <div>
            <div className="glass rounded-2xl p-5 glow-border sticky top-24 space-y-4">
              ...
              {/* Movie info */}
              {title && (
                <div className="flex items-start gap-3 p-3 rounded-xl bg-white/3 border border-[rgba(139,92,246,0.08)]">
                  {poster ? (
                    <img
                      src={`https://image.tmdb.org/t/p/w92${poster}`}
                      alt={title}
                      className="w-10 h-14 object-cover rounded-lg flex-none border border-[rgba(139,92,246,0.16)]"
                    />
                  ) : (
              ...
              <div className="border-t border-[rgba(139,92,246,0.13)] pt-3 space-y-2 text-sm">
                ...
                <div className="flex justify-between font-bold text-base pt-1.5 border-t border-[rgba(139,92,246,0.13)]">
              ...
              {method === "upi" && (
                <div className="text-center">
                  ...
                  <button onClick={handleUpiPay} className="w-full btn-primary py-3.5 justify-center font-semibold text-sm rounded-xl">
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#555]">Loading payment...</p>
        </div>
      </div>
    }>
      <PaymentPageInner />
