      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        ...
        <div className="w-full max-w-md fade-up scroll-reveal is-visible" style={{ animationDelay: "0.2s" }} ref={ticketRef}>
          <div className="ticket-card overflow-hidden">
            ...
            <div className="ticket-perforation border-t border-dashed border-white/10 mx-4" />
        ...
        {/* Nav links */}
        <div className="flex gap-3 mt-3 w-full max-w-md fade-up" style={{ animationDelay: "0.5s" }}>
          <Link
            href="/bookings"
