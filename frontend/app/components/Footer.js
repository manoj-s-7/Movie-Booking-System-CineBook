...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0d0d0d] border-t border-[rgba(139,92,246,0.08)] mt-16">
      <div className="max-w-screen-xl mx-auto px-6 py-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              {[Twitter, Instagram, Youtube, Facebook].map((Icon, i) => (
                <button
                  key={i}
                  className="w-8 h-8 rounded-full bg-white/5 border border-[rgba(139,92,246,0.16)] flex items-center justify-center text-[#666] hover:text-white hover:border-[rgba(139,92,246,0.35)] transition-all"
                >
                  <Icon size={14} />
                </button>
              ))}
        ...
        <div className="pt-6 border-t border-[rgba(139,92,246,0.08)] flex flex-col sm:flex-row items-center justify-between gap-3">
