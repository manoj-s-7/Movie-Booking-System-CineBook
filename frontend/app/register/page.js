  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      ...
      <div className="relative z-10 px-8 py-5 flex items-center justify-between">
        ...
        <Link href="/login" className="text-sm text-white bg-white/10 hover:bg-white/20 px-4 py-2 rounded transition-colors border border-[rgba(139,92,246,0.22)]">
          Sign In
        </Link>
      </div>
          ...
          <div className="rounded-2xl p-8 shadow-2xl" style={{ background: "rgba(0,0,0,0.82)", border: "1px solid rgba(255,255,255,0.08)", backdropFilter: "blur(20px)" }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={isLoading}
                ...
                {isLoading ? <div className="w-5 h-5 border-2 border-[rgba(255,255,255,0.30)] border-t-white rounded-full spin" />
